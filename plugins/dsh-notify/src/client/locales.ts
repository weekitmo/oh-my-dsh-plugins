export const zh = {
  ...
  'settings.sidebar.desc': '正常完成为绿色，错误、中止、阻塞和令牌限制为红色，等待授权为黄色；打开会话后清除。',
  ...
  'settings.outcomes.approval': '等待授权确认',
  'settings.sounds.title': '结果音效',
  'settings.sounds.enabled': '播放结果音效',
  'settings.sounds.enabledDesc': '为不同结果播放短提示音；不受系统通知开关影响，误点授权也不出声以外的副作用。',
  'settings.sounds.volume': '音量（0–100）',
  'settings.sounds.volumeDesc': '默认 60；0 表示静音。',
  'settings.sounds.volumeError': '请输入 0–100 之间的整数。',
  'settings.sounds.preview': '试听',
  ...
  'notify.approval': 'DSH 任务等待授权确认',
  'notify.approvalBody': '{tool} 需要你确认后才能继续',
...
export const en = {
  ...
  'settings.sidebar.desc': 'Green for completion; red for errors, aborts, blocks, and token limits; amber while an approval is waiting. Opening the session clears it.',
  ...
  'settings.outcomes.approval': 'Waiting for approval',
  'settings.sounds.title': 'Result sounds',
  'settings.sounds.enabled': 'Play result sounds',
  'settings.sounds.enabledDesc': 'Play a short clip per outcome; independent of the system-notification switch.',
  'settings.sounds.volume': 'Volume (0–100)',
  'settings.sounds.volumeDesc': 'Defaults to 60; 0 mutes.',
  'settings.sounds.volumeError': 'Enter an integer between 0 and 100.',
  'settings.sounds.preview': 'Preview',
  ...
  'notify.approval': 'DSH task is waiting for your approval',
  'notify.approvalBody': '{tool} needs your confirmation to continue',
  ...
  'title.approval': '{n} sessions waiting for approval',
